"""Integration tests for Huanxin + built-in plugins."""
...
# ══════════════════════════════════════════════════════════════════
# Huanxin.metrics (auto register)
# ══════════════════════════════════════════════════════════════════

class TestHuanxinMetricsLazy:
    """Huanxin.metrics property auto-creates and registers MetricsPlugin."""
...
class TestHuanxinMetricsWithLoggingPlugin:
    ...
    def test_when_metrics_registered_externally_first(self):
        """Huanxin eagerly registers MetricsPlugin on init, so
