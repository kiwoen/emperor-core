...
Package structure:
    ...
    benchmarks.py — 内置基准测试集（HuanxinBench / RouterBench / MultiStepBench / SelfHealingBench）

Usage:
    from huanxin.eval import EvalCase, EvalSuite, EvalRunner
    from huanxin.eval import HuanxinBench, RouterBench
    ...
    # 增强版 Benchmark 方式
    runner.run_benchmark("huanxin", agent=my_agent)
...
logger = logging.getLogger("huanxin.eval")
...
class JudgeEvalSuite:
    ...
    Usage:
        ...
        from huanxin.eval import JudgeEvalSuite, EvalRunner
...
class _LegacyEvalRunner:
    ...
    def run(self, suite: EvalSuite) -> SuiteResult:
        ...
        """
        from huanxin.llm_judge import LLMJudge, BatchCase
...
from huanxin.eval.runner import EvalRunner
...
__all__ = [
    ...
    "compute_all_metrics",
    # Benchmarks
    "HuanxinBench", "RouterBench", "MultiStepBench", "SelfHealingBench",
