"""Plugin system for Huanxin extensibility.
...
key points in the Huanxin lifecycle.

Usage:
    from huanxin.plugin import Plugin, PluginManager, LifecycleEvent
...
class LifecycleEvent(enum.Enum):
    """Events dispatched during Huanxin lifecycle."""
...
class Plugin(abc.ABC):
    """Base class for Huanxin plugins.
    ...
    def on_init(self, **kwargs: Any) -> None:
        """Called when Huanxin is initialized."""
        pass

    def on_shutdown(self, **kwargs: Any) -> None:
        """Called when Huanxin is shutting down."""
        pass
