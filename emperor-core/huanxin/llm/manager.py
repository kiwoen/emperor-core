...
This is a thin facade over :class:`huanxin.core.llm.LLMManager` — the canonical
...
from huanxin.llm.config import LLMConfig

logger = logging.getLogger("huanxin.llm.manager")
...
class LLMManager:
    """Multi-backend LLM manager delegating to ``huanxin.core.llm.LLMManager``.
    ...
    def __init__(
        ...
        *,
        ...
        import huanxin.core.llm as core
...
def build_manager_from_env() -> LLMManager:
    ...
    registry) to ``huanxin.core.llm.build_manager_from_env`` so the emperor
