...
Hot-pluggable module that bridges HUANXIN's message bus to VS Code
...
logger = logging.getLogger("huanxin.vscode")
    ...
    def _build_command(self, category: str, action: str, params: dict) -> Optional[Any]:
        ...
        if category == "file":
            ...
            if action == "send":
                ...
                return cmds.create_terminal(params.get("name", "HUANXIN"))
            elif action == "kill":
