...
<div class="app">
  ...
  <aside class="sidebar">
    <div class="brand">
      ...
      <div><div class="name">幻炘AI</div><div class="sub">自进化 AI 朝堂</div></div>
    </div>
  ...
  <section class="main">
    ...
    <div class="chat" id="chat">
      <div class="messages" id="messages">
        <div class="welcome" id="welcome">
          ...
          <div class="chips">
            <div class="chip" onclick="quick('用一句话介绍 幻炘AI 的自进化机制')">介绍自进化机制</div>
    ...
    <div class="composer">
      ...
      <div class="box">
        ...
        <textarea id="input" rows="1" placeholder="给 幻炘AI 发消息…（Enter 发送，Shift+Enter 换行）" oninput="autoGrow()" onkeydown="onKey(event)"></textarea>
...
<div class="overlay" id="overlay" style="display:none">
  <div class="authcard">
    ...
    <div class="sub" id="authSub">使用你的账号登录 幻炘AI</div>
...
const SYS_PROMPT = "你是 幻炘AI —— 一个会自我进化的 AI 助手，回答简洁、准确、有帮助。";
...
function switchTab(mode){
  ...
  document.getElementById('authSub').textContent = isReg ? '创建新账号，注册成功后自动登录' : '使用你的账号登录 幻炘AI';
...
function showWelcome(){
  document.getElementById('messages').innerHTML =
   '<div class="welcome" id="welcome"><h1>幻炘AI</h1>'+
