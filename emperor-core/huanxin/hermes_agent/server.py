...
logger = logging.getLogger("huanxin.hermes_agent.server")
...
class HermesMCPServer:
    ...
    async def _tool_publish(self, args: dict) -> dict:
        ...
        from huanxin.hermes.bus import Topic, Message, MessageType
...
async def _serve_stdio():
    ...
    bus = MessageBus()
    server = HermesMCPServer(bus, name="huanxin-hermes")
