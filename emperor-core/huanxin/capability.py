...
Usage:
    from huanxin.capability import Capability, CapabilityRegistry
...
logger = logging.getLogger("huanxin.capability")

# Module-level template manager (initialized by Huanxin / app startup)
