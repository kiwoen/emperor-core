"""
Sovereign CLI (天子殿) — Imperial Court interactive interface.
...
The Sovereign CLI presents the Imperial Court system through a polished
...
from huanxin.court.sovereign import CourtPhase, Sovereign, ImperialCourt
...
def print_banner() -> None:
    """Display the Sovereign banner."""
    console.print(HUANXIN_BANNER, style=STYLE_TITLE)


# ---------------------------------------------------------------------------
# Sovereign singleton — initialized once, shared across commands
# ---------------------------------------------------------------------------

_emperor_singleton: Optional[Sovereign] = None


def get_emperor() -> Sovereign:
    """Get or create the Sovereign singleton."""
    global _emperor_singleton
    if _emperor_singleton is None:
        _emperor_singleton = Sovereign()
...
def render_court_status(emperor: Sovereign) -> Table:
...
def render_evolution_history(emperor: Sovereign) -> Panel:
...
def render_merit_leaderboard(emperor: Sovereign) -> Table:
...
def render_minister_detail(emperor: Sovereign, minister_name: str) -> Optional[Panel]:
...
def _print_mini_header(emperor: Sovereign) -> None:
...
async def interactive_court(emperor: Sovereign) -> None:
    ...
    while True:
        ...
        def on_progress(phase: CourtPhase, detail: dict) -> None:
            """Callback from Sovereign pipeline — update live state + refresh."""
            state["phase"] = phase
...
def cmd_serve(args: argparse.Namespace) -> None:
    ...
    print_banner()
    console.print()
    console.print(f"[bold]启动 Sovereign API 服务[/] — {args.host}:{args.port}")
    console.print()
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="emperor",
        description="Sovereign — Imperial Court AI Orchestrator",
    )
