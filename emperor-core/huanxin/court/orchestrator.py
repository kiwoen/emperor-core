...
feedback into the Sovereign's pipeline.
...
from huanxin.court.sovereign import (
    CourtPhase,
    CourtRecord,
    Decree,
    Edict,
...
from huanxin.court.routing import IntelligentRouter, RoutingStrategy
from huanxin.court.calibration import ConfidenceCalibrator
from huanxin.court.memory import CourtMemory, QueryResult, memory_from_memorial
...
from huanxin.court.minister import MinisterState

logger = logging.getLogger("huanxin.court.orchestrator")
...
class SmartSovereign:
    """Drop-in replacement for Sovereign with routing + calibration.

    Usage:
        emperor = SmartSovereign()
