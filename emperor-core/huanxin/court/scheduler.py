...
no external dependencies) and fully integrated with Huanxin.
...
class Scheduler:
    ...
    def __init__(self, emperor: Any = None, db: Any = None) -> None:
        ...
        Args:
            emperor: Optional Huanxin instance. If not provided,
        ...
        self._alert_manager: Any = None   # injected by Huanxin.serve
        self._healing_engine: Any = None  # injected by Huanxin.serve

    @property
    def emperor(self) -> Any:
        """The Huanxin instance this scheduler is attached to."""
    ...
    def schedule_evolution(
        ...
        if self._emperor is None:
            raise RuntimeError("Scheduler has no Huanxin; use add_job() instead")
