...
The MeritBoard serves as the court's competitive backbone:
    ...
    5. Provides merit-weighted selection for Sovereign's court sessions
...
logger = logging.getLogger("huanxin.court.merit_board")
...
class DispatchEntry:
    ...
    feedback_score: float = 0.0  # post-hoc feedback from Sovereign/user
    timestamp: str = field(
