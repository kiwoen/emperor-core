"""SQLite persistence layer for Huanxin Dashboard.
...
logger = logging.getLogger("huanxin.database")
...
class Database:
    """SQLite-backed persistence for Huanxin system data.

    Usage:
        db = Database("path/to/huanxin.db")
