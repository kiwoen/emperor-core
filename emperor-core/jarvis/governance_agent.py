...
Integration:
    - jarvis.audit.AuditLogger   → immutable audit trail per decision
    - jarvis.approval.ApprovalEngine → auto-create approval for needs_approval

Usage:
    from jarvis.governance_agent import GovernanceAgent, GovernanceRule
...
logger = logging.getLogger("jarvis.governance_agent")
...
class GovernanceAgent:
    ...
    def __init__(
        ...
        Args:
            audit_logger: jarvis.audit.AuditLogger instance for immutable audit trail
            approval_engine: jarvis.approval.ApprovalEngine instance for HITL approval
