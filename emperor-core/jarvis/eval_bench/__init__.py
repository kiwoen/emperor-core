"""
jarvis.eval_bench — P0.6 可信评测基准（替代 llm_judge 关键词失真）。
...
Usage:
    from jarvis.eval_bench import run_suite, build_canonical_suite
...
from jarvis.eval_bench.suites.canonical import (
    CanonicalSuite,
