"""
HUANXIN API Server — FastAPI-based REST + WebSocket interface.
...
async def get_status() -> dict[str, Any]:
    return {
        "name": _config.name if _config else "HUANXIN",
...
async def submit_feedback(request: FeedbackRequest) -> dict[str, Any]:
    ...
    try:
        from huanxin.feedback import FeedbackEntry, get_feedback_store
...
async def get_feedback_stats() -> dict[str, Any]:
    ...
    try:
        from huanxin.feedback import get_feedback_store
...
async def get_feedback_dashboard() -> str:
    ...
    from huanxin.feedback import FEEDBACK_DASHBOARD_HTML
...
async def websocket_endpoint(websocket: WebSocket) -> None:
    ...
    await websocket.send_json({"type": "connected", "message": "HUANXIN at your service."})
