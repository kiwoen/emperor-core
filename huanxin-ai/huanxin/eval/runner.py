...
from huanxin.eval.metrics import MetricsReport, compute_all_metrics
...
class EvalRunner:
    ...
    def run(self, suite: Any) -> Any:
        ...
        """
        from huanxin.eval import _LegacyEvalRunner  # lazy to avoid circular import
    ...
    def run_benchmark(
        ...
        支持的内置名称:
            "huanxin"      — HuanxinBench (20 题覆盖 12 种能力)
    ...
    def run_custom_cases(
        ...
        """
        from huanxin.eval.benchmarks import Benchmark
