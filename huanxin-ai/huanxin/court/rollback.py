...
DEFAULT_SNAPSHOT_DIR = "huanxin/court/snapshots"
...
class RollbackManager:
    ...
    Args:
        snapshot_dir: 快照目录（相对仓库根；默认 ``huanxin/court/snapshots``）。
        genome_state_relpath: 运行中的基因检查点相对路径（回滚时同步更新）。
    """

    def __init__(self, snapshot_dir: str = DEFAULT_SNAPSHOT_DIR,
                 genome_state_relpath: str = "huanxin/court/genome_state.json") -> None:
