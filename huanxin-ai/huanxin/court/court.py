...
logger = logging.getLogger("huanxin.court.facade")
...
class CourtConfig:
    ...
    # heuristic (see huanxin.court.fitness), which means every minister the
...
class Court:
    ...
    def __init__(self, config: Optional[CourtConfig] = None) -> None:
        ...
        from huanxin.court.sliding_merit import SlidingMeritBoard, WindowMode
    ...
    def genome_state_payload(self) -> dict:
        ...
        exact shape :class:`~huanxin.court.genome_store.GenomeStore` persists.
