...
The Sovereign no longer needs to manually correct — the court evolves itself.
"""
...
if TYPE_CHECKING:
    ...
    from huanxin.court.history import EvolutionHistory

logger = logging.getLogger("huanxin.court.evolution")

from huanxin.court.diversity import (  # noqa: E402
    CatastropheReport,
    DiversityMonitor,
    DiversitySnapshot,
)
from huanxin.court.sliding_merit import (  # noqa: E402
    SlidingMeritBoard,
    WindowMode,
)
from huanxin.court.merit_board import MeritBoard  # noqa: E402
from huanxin.court.breeding import (  # noqa: E402
    AutoBreeder,
    BreedingReport,
    BreedingCandidate,
    BreedingStrategy,
...
from huanxin.court.genome_redispersal import (  # noqa: E402
    archetype_for_index,
    genomic_diversity,
    redisperse,
)
...
class SurvivalMechanism:
    ...
    def __init__(
        ...
        # (``huanxin.court.court.Court``) freezes it — see
        ...
        # (see huanxin.court.circuit_breaker.PromotionGate) instead of a single
    ...
    def set_genome(self, name: str, genome: MinisterGenome) -> None:
        ...
        genome replacement. Use this whenever an external actor (Sovereign,
