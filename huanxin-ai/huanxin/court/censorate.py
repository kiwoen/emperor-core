...
Inspired by:
    - Chinese imperial 御史台 (Censorate): independent from the bureaucracy,
      reported directly to the Sovereign, could impeach any official
...
It cannot be overruled by other ministers — only the Sovereign (or user feedback)
can override a veto.
"""
...
logger = logging.getLogger("huanxin.court.censorate")
...
class Censorate:
    ...
    async def review_decree(
        ...
        """Review the Sovereign's final decree (圣旨).

        The decree review is more lenient than individual memorial review
        because the Sovereign has already synthesized — but the Censorate
        ...
        # Decree gets a +0.1 leniency bonus (Sovereign's authority)
