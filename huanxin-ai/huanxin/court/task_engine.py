...
Usage:
    ...
    from huanxin.court.task_engine import TaskEngine, TaskRequest, TaskOutcome
...
def _simple_confidence(response: str, expected: Optional[str]) -> float:
    ...
    .. deprecated:: P0.3
        ...
        reward hacking).  :class:`huanxin.court.fitness.RealTaskFitness` is now
...
class TaskEngine:
    ...
    def _score(
        ...
        *,
        ...
        :class:`~huanxin.court.fitness.RealTaskFitness` (the default) receives a
    ...
    def _select_minister(self, domain: str, prompt: str = "") -> str:
        ...
        merit (highest first):
            ...
            2. **Capability match** — the minister's domain and the request map
               to the same :class:`~huanxin.model_router.Capability` according to
