...
huanxin-ai 已有沙箱(GitWriteChannel 只开 PR) 与人类审批门(approval_gate)，
...
logger = logging.getLogger("huanxin.court.safety_gate")
...
DEFAULT_PROTECTED_PATHS: Sequence[str] = (
    "huanxin/court/circuit_breaker.py",
    "huanxin/court/safety_gate.py",
    "huanxin/court/writeback_gate.py",
    "huanxin/vcs/",
    "huanxin/approval.py",
    "huanxin/audit.py",
)
