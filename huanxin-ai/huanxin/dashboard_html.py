...
for the Huanxin dashboard. No external CSS/JS — everything is inline.
...
<div class="header">
  <h1>Huanxin Evolution Dashboard</h1>
  <div>
...
<div class="footer">
  幻炘AI &middot; Auto-refresh every 3s &middot; <span id="footerCycle">--</span>
</div>
