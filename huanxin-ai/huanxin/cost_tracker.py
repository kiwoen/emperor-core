"""
HUANXIN Cost Tracker — per-invocation cost recording and reporting.
...
logger = logging.getLogger("huanxin.cost_tracker")
...
class CostTracker:
    ...
    def _compute_cost(model_name: str, tokens_in: int, tokens_out: int) -> float:
        ...
        try:
            ...
            from huanxin.multi_model import _DEFAULT_MODELS
