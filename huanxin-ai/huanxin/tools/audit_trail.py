...
Usage::
    ...
    from huanxin.tools.audit_trail import AuditTrail, AuditReplayer
...
Database lives at huanxin_data/audit.db (auto-created).
...
logger = logging.getLogger("huanxin.tools.audit_trail")

# ── Constants ─────────────────────────────────────────────────
_DEFAULT_DB_PATH = "huanxin_data/audit.db"
_ARCHIVE_AGE_DAYS = 30
_ARCHIVE_DIR = "huanxin_data/audit_archive"
