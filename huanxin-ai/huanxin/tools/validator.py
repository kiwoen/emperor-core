...
Integration:
  Designed to complement huanxin.tool_guard.ToolGuardMiddleware.
...
Usage:
    ...
    from huanxin.tools.validator import ToolCallValidator, safe_execute
...
logger = logging.getLogger("huanxin.tools.validator")
