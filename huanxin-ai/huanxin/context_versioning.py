...
Design principles:
  ...
  - Zero external dependencies — pure stdlib + existing Huanxin modules
...
logger = logging.getLogger("huanxin.context_versioning")
...
class ContextVersioning:
    """Central versioning engine for Huanxin system state.
    ...
    def __init__(
        ...
        Args:
            data_dir:       Huanxin data directory (snapshots stored in data_dir/versions/)
