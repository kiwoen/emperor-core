...
existed, ``huanxin/emperor.py`` imported ``huanxin.model_router.SmartRouter``
...
Usage::
    ...
    from huanxin.model_router import SmartRouter, Capability
...
logger = logging.getLogger("huanxin.model_router")
