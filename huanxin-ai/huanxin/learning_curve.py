...
persistent data volume (``HUANXIN_DATA_DIR``, default ``/app/data``). Because it
...
logger = logging.getLogger("huanxin.learning_curve")
...
def _resolve_path() -> Path:
    ...
    base = os.environ.get("HUANXIN_DATA_DIR", "").strip()
