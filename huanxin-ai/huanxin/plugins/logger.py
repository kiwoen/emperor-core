"""LoggingPlugin — Structured JSON-Lines logging of Huanxin lifecycle events.
...
Usage:
    from huanxin.plugins import LoggingPlugin
...
class LoggingPlugin(Plugin):
    """Structured JSON-lines logger for Huanxin lifecycle events.
