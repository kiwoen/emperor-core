...
The old scorer (``jarvis.court.task_engine._simple_confidence``) awarded up to
...
Usage::
    ...
    from jarvis.court.fitness import RealTaskFitness, FitnessSignal
...
logger = logging.getLogger("jarvis.court.fitness")
