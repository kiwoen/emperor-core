...
for Emperor's dispatch pipeline.
...
Usage:
    from jarvis.state_machine import StateMachine, create_dispatch_workflow
...
def create_dispatch_workflow() -> StateMachine:
    ...
    This is the standard Emperor task execution pipeline:
...
def _describe_workflow(name: str) -> str:
    descriptions = {
        "dispatch_workflow": (
            "Standard Emperor task dispatch pipeline: "
